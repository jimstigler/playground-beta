...
/* ── Print / PDF fallback ────────────────────────────────────────────────────
   Applied when window.open() is blocked by a popup blocker and we fall back
   to window.print() on the main window. The primary path (new print window)
   has its own inline styles and doesn't use these rules.              ───── */
@media print {
  @page {
  ...
  /* Reset Lumino's absolute-position layout to natural document flow */
  .jp-LabShell,
  .jp-NotebookPanel,
  .jp-Notebook {
  ...
  .cm-content { white-space: pre-wrap !important; }
...
//# sourceMappingURL=style_index_js.f81a7095d054928d3c08.js.map