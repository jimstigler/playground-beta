...
.je-cell-run-button jp-button {
  --focus-stroke-outer: transparent !important;
  --focus-stroke-inner: transparent !important;
}

.je-cell-run-button jp-button::part(control),
.je-cell-run-button jp-button:focus::part(control),
.je-cell-run-button jp-button:focus-visible::part(control) {
  outline: none !important;
  box-shadow: none !important;
  border: none !important;
}

.je-cell-run-button:focus,
.je-cell-run-button:focus-visible {
  outline: none !important;
}
...
/* Hide the ReactiveToolbar popup opener ("...") — overflow is handled by
   disabling the resizer in JS (notebook.tsx widgetAdded) and by making
   the toolbar scrollable above as a safety net. */
.jp-NotebookPanel-toolbar .jp-Toolbar-responsive-opener {
  display: none !important;
}
...
/* ── Print / PDF export ──────────────────────────────────────────────────────
   exportNotebookAsPDF() copies notebook.content.node.innerHTML into
   #je-print-container (a clean div appended to <body>), then calls
   window.print(). @media print hides everything else and shows only that div.
   This sidesteps Lumino's absolute-position layout entirely:
     • Rendered markdown — already in innerHTML as HTML, not raw text
     • MathJax — already typeset as <mjx-container> elements
     • Syntax-highlighted code — CodeMirror DOM already in innerHTML
     • Cross-origin images — browser native print, no canvas restriction ── */

/* Hidden in normal view; only shown during print */
#je-print-container {
  display: none;
}
...
@media print {
  ...
  /* Hide the entire Lumino app; show only our snapshot container */
  body > *:not(#je-print-container) {
    display: none !important;
  }
  ...
  /* ── Markdown cells ──────────────────────────────────────────────────── */
  /* innerHTML includes both editor and rendered wrappers; show only rendered */
  #je-print-container .jp-MarkdownCell .jp-Cell-inputWrapper {
    display: none !important;
  }
  #je-print-container .jp-MarkdownCell .jp-Cell-outputWrapper {
    display: block !important;
  }
  #je-print-container .jp-MarkdownCell .jp-RenderedMarkdown {
    padding: 0 4px !important;
  }

  /* ── Hide UI chrome ──────────────────────────────────────────────────── */
  #je-print-container .jp-InputArea-prompt,
  #je-print-container .je-cell-run-button {
    display: none !important;
  }

  /* Keep headings attached to the content that follows */
  #je-print-container h1, #je-print-container h2, #je-print-container h3,
  #je-print-container h4, #je-print-container h5, #je-print-container h6 {
    break-after: avoid;
    page-break-after: avoid;
  }

  /* ── Code editors (CodeMirror 6) ─────────────────────────────────────── */
  #je-print-container .jp-CodeMirrorEditor,
  #je-print-container .cm-editor,
  #je-print-container .cm-scroller {
    height: auto !important;
    overflow: visible !important;
  }
  #je-print-container .cm-content {
    white-space: pre-wrap !important;
    word-break: break-all;
  }

  /* ── Output areas ────────────────────────────────────────────────────── */
  #je-print-container .jp-OutputArea,
  #je-print-container .jp-OutputArea-child,
  #je-print-container .jp-OutputArea-output {
    overflow: visible !important;
    max-height: none !important;
    height: auto !important;
  }
  #je-print-container pre {
    white-space: pre-wrap !important;
    overflow: visible !important;
    word-break: break-all;
  }
  ...
  /* ── Images & figures ────────────────────────────────────────────────── */
  #je-print-container img,
  #je-print-container svg {
...
//# sourceMappingURL=style_index_js.89da4a3601449f027f8c.js.map